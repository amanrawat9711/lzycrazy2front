...
const AnimatedCards = () => {
  ...
  return (
    ...
    <div className="overflow-hidden w-[80%] bg-gray-100 py-8"> 
      <div
        className={`flex space-x-4 transition-transform duration-3000 ease-linear ${
      ...
      > 
        {cardsData.concat(cardsData).map((card, index) => (
          <div
            key={index}
            className="w-72 bg-white rounded-lg shadow-md flex-shrink-0"
          > 
            <img
              src={card.image}
              alt="Sample"
